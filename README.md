...
```javascript
 // Dados de exemplo preenchendo todos os dias de 6 a 5 e todas as categorias
    ...
    var option = {
      ...
      yAxis: {
        type: 'category',
        data: ['INTERNAÇÃO DE MERCADORIA', 'VEÍCULO FORA DE ROTA', 'CARGA MAIOR QUE CAPACIDADE', 'VEÍCULO SEM MDFE'],
        splitArea: {
          show: true
        }
      },
...
$.get(
  ...
  function (obama_budget_2012) {
    ...
    option = {
      ...
      calculable: true,
      legend: {
        data: ["Veículo Sem MDFE", "Carga Medida Maior que MDFE", "Veículo Fora de Rota", "Internação de Mercadoria"],
        itemGap: 15
      },
      grid: {
        top: '12%',
...
#### Produtos que mais circulam no estado de acordo com os mdfes dos alertas
```javascript
option = {
  tooltip: {
    trigger: 'item',
  ...
  series: [
    {
     ...
     label: {
      ...
      data: [
        { value: 1048, name: 'Alimentos' },
            { value: 335, name: 'Cimento' },
            { value: 310, name: 'Fertilizantes' },
            { value: 251, name: 'Madeira' },
            { value: 234, name: 'Máquinas' },
      ]
    }
  ]
};
